...
* The original package name 'com.hcm.scm2.0' is invalid and this project uses 'com.hcm.scm20' instead.
...
* [Validation](https://docs.spring.io/spring-boot/docs/3.3.5-SNAPSHOT/reference/htmlsingle/index.html#io.validation)
